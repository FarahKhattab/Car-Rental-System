...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Search Wanted Car Specs</h1>
    ...
    <!-- Three columns of text below the carousel -->
                <div class="row">
                    <form method="post">
                        <input type="text" placeholder="Search data" id="search" name="search">
                        <button name="submitSearch" class="btn btn-dark">Search</button>
                                    ...
                                    <table class="table table-image">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col"></th> <!-- New column for the "Rent" button -->
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    echo '<td><a href="displaySelectedCar.php?data=' . $r[0] . '">' . $r[0] . '</a></td>';
                                                    echo '<td>' . $r[1] . '</td>';
                                                    echo '<td>' . $r[2] . '</td>';
                                                    echo '<td>' . $r[3] . '</td>';
                                                    echo '<td>' . $r[4] . '</td>';
