                    ...
                    <body>
                        ...
                        <div class="container">
                            ...
                            <div class="rental-form-container">
                                <button id="showDateInputs" class="btn btn-primary">Choose Dates</button>
                                <form id="rentalForm" action="showCarStatus.php" method="POST" style="display: none;">
                                    <div id="dateInputs" class="form-group mt-3">
