        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="row">
                    ...
                    echo '<h1> Car Plate:' . $plate_no . '</h1>';
                 
                    ?>
                    <form action="handleUpdateStatus.php" method="post">
                        <div class="form-group">
                            <label for="status">Status</label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="available"
                                    value="available">
                                <label class="form-check-label" for="male">Available</label>
                            </div>
                            <div class="form-check">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="out of service"
                                    value="out of service">
                                <label class="form-check-label" for="female">Out of Service</label>
                            </div>
                        </div>
                        <button class="btn btn-primary w-50 py-2" type="submit">Save</button>
                    </form>
