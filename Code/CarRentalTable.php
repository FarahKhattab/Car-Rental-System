...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $plate_number = $_POST["plate_number"]; // Fetch rental ID
    $rentals =rental::getCarRentals($plate_number);   
}
else{
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Rentals of car with plate#:
                        <?php
                    echo  $plate_number;
                    ?>
                    </h1>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <table class="table table-image">
                                <thead>
                                    <tr>
                                        <th scope="col">User Social Security #</th>
                    ...
                    $num_rows = count($rentals);

                    if($num_rows==0)
                    {
                        echo '<tr><td>The car wasn\'t rented by any user</td></tr>';
                    }
                    else{
                        foreach ($rentals as $r) {
                            echo '<tr>';
                            echo '<td>' . $r["user_ssn"] . '</td>';
                            echo '<td>' . $r["reservation_date"] . '</td>';
                            echo '<td>' . $r["pick_up_date"] . '</td>';
