    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <!-- PHP script to display all users -->
                <?php
                require_once("config.php");
                $cn = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);

                $sql = "SELECT u.*, COUNT(r.user_ssn) AS rental_records
                        FROM user AS u
                        LEFT JOIN rental AS r ON u.ssn = r.user_ssn
                        GROUP BY u.ssn;
                        "; // SQL to get all users and the number of their rentals
                ...
                <table class="table table-image">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Rental Records</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <?php
                                    ...
                                    ?>
                            <td>
                                <!-- This form will submit to a PHP script that handles the history viewing -->
                                <form action="viewReservationHistory.php" method="post">
                                    <!-- Send the SSN as a hidden field -->
                                    <input type="hidden" name="ssn" value="<?php echo htmlspecialchars($r[0]); ?>">
