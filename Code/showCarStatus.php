                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="availableCars.php">
                                    <svg class="bi">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="RentedCars.php">
                                    <svg class="bi">
                                        <use xlink:href="#car-front-fill" />
                                    </svg>
                                    Rented Cars
...
FROM
    car
LEFT JOIN
    rental ON car.plate_no = rental.plate_no";
                            ...
                            <table class="table table-image">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Status</th> <!-- New column for the "Rent" button -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                                ...
                                                if ($startDate >= $r[2] && $startDate <= $r[3]) {
                                                    $status = "rented";
                                                }
                            ...
                            <?php
                                ...
                                echo "No rentals found at $startDate ";
                            }
