...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div
                    ...
                    <h1 class="h2">Search For a User</h1>
    ...
    <!-- Three columns of text below the carousel -->
                <div class="row">
                    <form method="post">
                        <input type="text" placeholder="Enter Info of User" id="user" name="user">
                        <button name="submitUser" class="btn btn-dark">Search</button>
                        ...
                        <table class="table table-image">
                            <thead>
                                <tr>
                                    ...
                                    <!-- New column for the "Rent" button -->
                                    ...
                                    <td>
                                        <form action="viewReservationHistory.php" method="post">
                                            ...
                                            <input type="hidden" name="ssn"
                                                value="<?php echo htmlspecialchars($r[0]); ?>">
