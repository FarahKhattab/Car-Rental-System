...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['mySelect'])) {
        ...
        // You can perform other actions or processing with the selected value here

        // For example, based on the selected value, perform different actions
        switch ($selectedValue) {
            case '1':
                // If 'One' was selected, perform some action
                //echo "One was selected!";
                // Fetch the user's cars
                $allCars = car::getCars();
                break;
            case '2':
                // If 'Two' was selected, perform another action
                //echo "Two was selected!";
                $allCars = car::getThisUserCars();
                break;
            case '3':
                // If 'Three' was selected, perform a different action
                //echo "Three was selected!";
                $allCars = car::getrentedCars();
                break;
            default:
...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white"
            href="#"><?php echo "Admin: " . $admin->firstName . " " . $admin->secondName;  ?> </a>
                                    ...
                                    <table class="table table-image">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="w-25">
                                                    <?php
                                                        echo '<img src="' . $car[8] . '" alt="' . $car[8] . '" class="img-fluid img-thumbnail">';
                                                        ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="CarRentalTable.php" method="post">
                                                            <input type="hidden" name="plate_number"
                                                                value="<?= $car[0] ?>">
                                                            <button class="btn btn-primary" data-toggle="modal"
                                                                data-target="#myModal<?= $car[0] ?>">View
                                                                Rentals</button>
                                                        </form>
                                                    </div>
                                                </td>
