...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Check Reservation Dates</h1>
    ...
    <!-- Three columns of text below the carousel -->
                <div class="row">
                    <div class="row">
                        <form method="post">
                            <input type="text" placeholder="Enter a reservation date" id="reserve" name="reserve">
                            <button name="reserveS" class=" btn btn-dark">Search</button>
                        ...
                        <div>
                            ...
                            if (isset($_POST['reserveS'])) {
                                ...
                                $sql = "SELECT car.plate_no,car.status, rental.reservation_date, rental.return_date
                                FROM car
                                left join rental 
                                on car.plate_no=rental.plate_no
